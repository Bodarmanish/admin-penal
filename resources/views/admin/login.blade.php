...
<body>
        ...
        @if(session()->has("flash_message_access"))
            <div id="gritter-notice-wrapper">
                <div id="gritter-item-1" class="gritter-item-wrapper" style="opacity: 0.7;">
                   <div class="gritter-top"></div>
                    <div class="gritter-item" style="background:red">
                     <div class="gritter-with-image">
                        <span class="gritter-title">{{session()->get("flash_message_access")}}</span>
                      </div>
                    <div style="clear:both"></div>
                  </div>
                <div class="gritter-bottom"></div>
    ...
    <script src="{{asset('login172/vendor/bootstrap/js/bootstrap.min.js ')}}"></script>
